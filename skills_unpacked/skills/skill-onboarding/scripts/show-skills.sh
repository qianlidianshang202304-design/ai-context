...
# Scans: ~/.cursor/skills, ~/.claude/skills, ~/.codebuddy/skills, ~/.yuyi/skills, project-level

COMPACT=false
[[ "${1:-}" == "--compact" ]] && COMPACT=true

# All possible skill directories
CANDIDATES=(
    "$HOME/.cursor/skills"
    "$HOME/.claude/skills"
...
if [[ -n "$PROJECT_ROOT" ]]; then
    for sub in .cursor/skills .claude/skills .codebuddy/skills .yuyi/skills; do
